/** mobile_user/lib/features/marketplace/category_icons.dart va
 * backend/app/core/category_icons.py bilan aynan bir xil ro'yxat —
 * admin faqat shu 18 tadan birini tanlay oladi, yangisi qo'shilmaydi. */
export const CATEGORY_ICON_PATHS: Record<string, string> = {
  ...
  qaychi:
    "M9 9 19 19M19 5 9 15M4 7.5a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0M4 16.5a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0",
...
export const CATEGORY_ICON_KEYS = Object.keys(CATEGORY_ICON_PATHS);
